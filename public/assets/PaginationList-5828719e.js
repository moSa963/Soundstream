import{e as _,g as $,ae as R,s as M,_ as g,W as U,af as v,k as j,l as B,m as E,j as b,n as N,o as A,R as u,a9 as P,c as X,B as W,d as D}from"./index-ed23adba.js";function F(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function K(t){return parseFloat(t)}function L(t){return _("MuiSkeleton",t)}$("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const T=["animation","className","component","height","style","variant","width"];let m=t=>t,x,C,k,w;const q=t=>{const{classes:e,variant:a,animation:s,hasChildren:r,width:n,height:o}=t;return A({root:["root",a,s,r&&"withChildren",r&&!n&&"fitContent",r&&!o&&"heightAuto"]},L,e)},O=R(x||(x=m`
  0% {
    opacity: 1;
  }
